...
import org.usfirst.frc.team3356.robot.subsystems.Climber;
import org.usfirst.frc.team3356.robot.subsystems.DriveTrain;
...
public class Robot extends IterativeRobot
{
  ...
  public void robotInit() {
    ...
    climber = new Climber();
    oi = new OI();
    RobotMap.driveTrainMotors.setSafetyEnabled(true);
    RobotMap.climber.setSafetyEnabled(true);
  ...
  public void testInit() {
    Robot.testMotor = new CANTalon(21);
  }
